...
public class caregiverReviews extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        Vector<reviewsData> CaregiverReview;
		CaregiverReview = reviewsData.getCaregiverReviews(connection, id);
        for(int i=0; i< CaregiverReview.size(); i++){
                reviewsData reviews = CaregiverReview.elementAt(i);
				toClient.println("<li>");
		...
		Vector<reviewsData> CaregiverPendingReview;
		CaregiverPendingReview = reviewsData.getPendingReviews(connection, id);
        for(int i=0; i< CaregiverPendingReview.size(); i++){
                reviewsData pendingReview = CaregiverPendingReview.elementAt(i);
				toClient.println("<li>");
				toClient.println("<div class='boxed-list-item'>");
				toClient.println("<div class='item-content'>");
