...
public class caregiverWarnings extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        Vector<warningData> caregiverWarnings;
		caregiverWarnings = warningData.getCaregiverWarnings(connection, id);

        for(int i=0; i< caregiverWarnings.size(); i++){
				warningData warning = caregiverWarnings.elementAt(i);
				if (i!=0) {
					toClient.print(",");
				}
        ...
        toClient.println(CaregiverUtils.footer("Products"));
		toClient.println("</div>");
