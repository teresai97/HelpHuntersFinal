...
public class messageData {
    ...
    messageData (int clientID, int caregiverID, String subject, String message, Date datecreated, Date datereplied ) {
	 ...
	 messageData (int clientID, int caregiverID, String subject, String message) {
		this.clientID = clientID;
		this.caregiverID = caregiverID;
		this.subject = subject;
        this.message = message;
	...
	messageData (String firstname, String lastname, String subject, String message, String reply, Date datecreated) {
	...
	messageData (String firstname, String lastname, int caregiverID) {
		this.firstname = firstname;
		this.lastname = lastname;
		this.caregiverID = caregiverID;
	}

	public static int sendMessage(Connection connection, messageData message) {
	...
	public static Vector<messageData> getMessages(Connection connection, int clientID) {
