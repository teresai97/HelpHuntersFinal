...
public class provinceData {
	...
	provinceData (Integer caregiverID, Integer provinceID) {
		this.caregiverID = caregiverID;
        this.provinceID = provinceID;
    }
	
	provinceData (Integer count) {
        this.count = count;
    }
	
		
    public static int insertCaregiverProvince(Connection connection, provinceData caregiverProvince) {
	...
	public static int updateCaregiverProvince(Connection connection, provinceData province) {
	...
	public static provinceData countCaregiverInProvince(Connection connection, int id) {
		...
		provinceData CaregiverInProvince = null;;
		try {
			PreparedStatement pstmt = connection.prepareStatement(sql);
			pstmt.setInt(1, id);
			ResultSet result = pstmt.executeQuery();
			if(result.next()) {
				CaregiverInProvince = new provinceData(
