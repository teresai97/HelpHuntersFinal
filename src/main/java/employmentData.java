...
public class employmentData {
	...
	employmentData (Integer status, Integer employmentID) {
		this.status = status;
        this.employmentID = employmentID;
    }
	
	employmentData (Integer hires) {
		this.hires = hires;
    }
	
	public static int updateEmploymentStatus(Connection connection, employmentData status) {
